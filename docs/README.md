...
| **participations** | Участники конкретных дней мероприятий |
| **menus** | Меню мероприятий |
...
![Диграмма "Сущность - Связь"](database/v1/images/er.svg)

### Рисунок 1.2 - Схема базы данных
![Схема базы данных](database/v1/images/db.svg)
