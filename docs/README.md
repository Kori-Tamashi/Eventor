...
5) menu – таблица меню дней мероприятий;
6) items – таблица предметов меню;
7) feedbacks – таблица отзывов участников;
8) users – таблица пользователей.
...
| permissions | Строковый | NOT NULL | Права доступа |
